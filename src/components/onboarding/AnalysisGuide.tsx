...
const EXAMPLE_USE_CASES: ExampleUseCase[] = [
  {
    ...
    description:
      "Quick overview of your DeFi wallet activity and token balances",
...
export function AnalysisGuide({
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "examples" | "tips">(
    "overview"
  );
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Eagle Eye provides comprehensive blockchain analytics for
                  Aptos wallets. Our platform helps you understand transaction
                  patterns, token movements, and wallet behavior with
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                        Enter one or multiple Aptos wallet addresses. You can
                        paste them directly or use our validation tools.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                        Choose time range, analysis depth, and token coverage.
                        Smart defaults are applied for optimal results.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                        Receive comprehensive analysis with visualizations,
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Get started quickly with these pre-configured analysis
                  templates. Click any example to load it into your analysis.
                </p>
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 text-xs">
                        <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded">
                          {example.addresses.length} wallet
                          {example.addresses.length !== 1 ? "s" : ""}
                        </span>
                        <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded">
                          {example.timeRange}
                        </span>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      Begin with a single wallet and quick analysis to
                      understand the platform. Once comfortable, expand to
                      multiple wallets and comprehensive analysis for deeper
                      insights.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1">
                      <li>
                        • <strong>7 days:</strong> Recent activity and quick
                        overview
                      </li>
                      <li>
                        • <strong>30 days:</strong> Monthly patterns and trends
                      </li>
                      <li>
                        • <strong>90 days:</strong> Quarterly analysis and
                        seasonal patterns
                      </li>
                      <li>
                        • <strong>Custom:</strong> Specific events or
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <ul className="text-sm text-green-800 dark:text-green-300 space-y-1">
                      <li>
                        • <strong>Quick:</strong> Basic metrics and overview
                        (fastest)
                      </li>
                      <li>
                        • <strong>Detailed:</strong> Comprehensive analysis with
                        charts (balanced)
                      </li>
                      <li>
                        • <strong>Comprehensive:</strong> Full analysis with
                        advanced metrics (most thorough)
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                    ...
                    <ul className="text-sm text-purple-800 dark:text-purple-300 space-y-1">
                      <li>
                        • <strong>APT Only:</strong> Focus on native token
                        activity
                      </li>
                      <li>
                        • <strong>Stablecoins:</strong> Trading and DeFi
                        analysis
                      </li>
                      <li>
                        • <strong>All Tokens:</strong> Complete portfolio
                        overview
                      </li>
                      <li>
                        • <strong>Custom:</strong> Specific token investigation
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                    ...
                    <ul className="text-sm text-indigo-800 dark:text-indigo-300 space-y-1">
                      <li>
                        • Group related wallets for comprehensive analysis
                      </li>
                      <li>
                        • Compare activity patterns across multiple addresses
                      </li>
